...
public class TestCounter {
    ...
    public static void main(String[] args) {
        ...
        counter1.equals(s); // act like a Set
...
// 30
        ...
        counter1.addText("ciao da me");
// overflow
/*
        counter1.addText("ciao da me"); // they are all added 
        assert counter1.size() == 9;
        
        try {
            counter2.addText("ciao da me");
            assert false;
        } catch (Exception e) {
            assert e.msg.equals("addText() only works for Counter<String>, not other types of Counter<>");
            assert true;
        }
        /**/
    }
